<template>
  <div class="signUpPeople commonHeader">
    ...
    <div v-transfer-dom>
      <alert v-model="signUpSuccess" title="申请成功" @on-hide="signUpSuccess=false"> 您已成为协办人 ！</alert>
    </div>
    <div v-transfer-dom>
      <alert v-model="cancelSignUpSuccess" title="取消申请成功" @on-hide="cancelSignUpSuccess=false"> 您已取消申请成为协办人 ！</alert>
    </div>
  </div>
</template>
<script>
