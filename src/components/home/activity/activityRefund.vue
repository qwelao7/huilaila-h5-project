<template>
  <div class="publish commonHeader no-margin-top" style="background-color: #f5f5f5">
    ...
    <div class="signUp">
      <ul v-if="!needDetail">
        <li class="others">
          ...
          <span>11fdasf</span><span class="applyUserCount">(2人)</span>
          <input type="text" class="refundMoney" placeholder="请输入退款金额">
        </li>
      </ul>
          ...
          <div class="signUpPeople_informaton">
            <div class="left">
              ...
              <div class="sp_name">
                ...
                <input type="text" class="refundMoney" style="float: right" placeholder="请输入退款金额" v-model="item.refund"
    ...
    <div class="btn-submit">
      ...
      <x-button type="primary" action-type="button" v-if="!isBalanced" style="background-color: #d8d8d8">确 定</x-button>
    </div>
  </div>
</template>
<script>
