  ...
  <div class="addPerson commonHeader">
    ...
    <div class="itemList">
      <group class="items avatar">
        <cell is-link @click.native="chooseAvatar">
          <span>头像</span>
          <img :src="userAvatar" alt="" v-show="userAvatar">
          <img src="../../../assets/images/default_avatar.png" alt="" v-show="!userAvatar">
        </cell>
      </group>
      <group class="items">
  ...
  export default {
    ...
    methods: {
        ...
        if (id !== 'addNew') {
          ...
          _this_.$JHttp({
            ...
            if (res.status === 100) {
              ...
              _this_.userAvatar = data.joinUserPhoto;
            ...
            _this_.$wechat.getLocalImgData({
              ...
              success: function (res) {
                ...
                _this_.$JHttp.post(window.uploadURL + '/upload', uploadData, {
                  ...
                  if (res.status === 100) {
                    let data = res.data;
                    _this_.userAvatar = localId
                    _this_.avatar = data[0]
                  } else {
      ...
      submit () {
        ...
        let params = {
          joinUserPhoto: _this.avatar || _this.userAvatar,
