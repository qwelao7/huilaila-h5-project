<template>
  <div class="signUpDetails commonHeader">
    ...
    <div class="signUp" v-show="!showBlankPage">
      ...
      <div class="joinPeople_detail" v-show="joinUsersInfo.applyUser">
        <div class="join_people">
          <div class="join_name">
            报名人：{{joinUsersInfo.applyUser.userName || joinUsersInfo.applyUser.nickname}}
          </div>
          <div class="phone">
            <a style="width: 100%;height: 100%;display: block;" :href="'tel:' + joinUsersInfo.applyUser.mobileNum"></a>
          </div>
        </div>
