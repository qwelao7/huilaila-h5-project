        ...
        <j-pull :refreshFunc="refreshData" :loadMoreFunc="loadMore">
          <div slot="jpull-list">
            <div class="detailBanner">
              ...
              <div class="introduce">
                <p v-html="detailObj.topicContent"></p>
            ...
            <div class="commentList no-margin-top">
              <group>
                <cell-box is-link class="likeList" v-show="detailObj.topicPraiseNumber"
                          @click.native="toPraiseList(detailObj.neighborId)">
                  <div>
        ...
        this.$JHttp({
          ...
          if (res.status === 100) {
            ...
            if (_this.detailObj.topicType === 8) {
              _this.title = '圈子'
            } else if (_this.detailObj.topicType === 6) {
              _this.title = '新鲜事'
            } else if (_this.detailObj.topicType === 2) {
              _this.title = '活动'
            } else if (_this.detailObj.topicType === 11) {
              _this.title = '活动相册'
            }
          } else {
            _this.$vux.loading.hide();
