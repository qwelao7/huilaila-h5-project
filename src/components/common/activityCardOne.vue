  ...
  <div class="act-card">
    <div class="main-banner">
      ...
      <div class="imgList">
        ...
        <div v-transfer-dom>
          <previewer ref="previewer" :list="information.container.imgList" :options="options(ind)">
            <!--<template slot="button-after">
              <span class="previewer-delete-icon-box">
                <img src="../../assets/arrow_open_greysmall.png" style="width: 22px;height: 22px" class="previewer-delete-icon"
...
<script>
  ...
  export default {
    ...
    components: {
      Previewer, XHeader, XInput, Divider, Actionsheet, Group, XDialog, Popup, XTextarea
    },
    props: {
      dataList: {
        type: Object,
    ...
    methods: {
      getInformation () {
        ...
        let length = this.information.container.imgList.length;
        if (length === 1) {
          this.isOne = true
        }
      },
      ...
      replyMsg (value) {
        ...
        let id;
        let _this = this;
        if (value.topicType === 8) {
          type = 5;
          id = value.neighborId
        } else if (value.topicType === 6) {
          type = 1;
          id = value.neighborId
