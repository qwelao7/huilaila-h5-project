  ...
  <div class="commonHeader verifiedName">
    ...
    <div class="unVerified" v-show="(status === 2 || status === 3)">
      ...
      <div class="input">
        <group class="optionItem">
          ...
          <x-input class="hasTop" :class="{noTop: realName}" :show-clear="!!realName" placeholder="姓名" v-model="realName" @on-change="onInput"></x-input>
        </group>
        <group class="optionItem">
          <group-title slot="title" v-show="idCode">身份证号</group-title>
          <x-input class="hasTop" :class="{noTop: idCode}" :show-clear="!!idCode" placeholder="身份证号" v-model="idCode"></x-input>
        </group>
      </div>
      <div class="idPic">
        <p>上传身份证照片：</p>
    ...
    <div class="isVerified" v-show="status === 1">
      <group class="optionItem">
        ...
        <x-input class="hasTop" :class="{noTop: realName}" :show-clear="!!realName"  placeholder="姓名" readonly v-model="realName"></x-input>
      </group>
      <div class="pic">
    ...
    <div class="isVerified" v-show="status === 0">
      <group class="optionItem">
        <group-title slot="title">姓名</group-title>
        <x-input class="hasTop" :class="{noTop: preViewName}" :show-clear="!!preViewName" placeholder="姓名" readonly v-model="preViewName"></x-input>
      </group>
      <div class="pic">
  ...
  export default {
    ...
    data () {
      return {
        ...
        status: 3,
        realName: '', // 真实姓名
        preViewName: localStorage.getItem('preViewName'),
        idCode: '', // 身份证
        idImg1: '', // 正面
        idImg2: '', // 反面
    ...
    methods: {
      ...
      onInput (value) {
        ...
        localStorage.setItem('preViewName', value)
      }
    }
  }
</script>
