    ...
    <div class="commonHeader house-detail-wrapper">
      <view-box body-padding-top="1.253333rem" body-padding-bottom="1.333333">
        <x-header
          ...
          <span v-if="isCurrent" slot="right" style="font-size: 15px; color: #333;" @click="showLeaveAddressModal">搬离此住址</span>
        </x-header>
        ...
        <div v-if="!isCurrent" class="submit" @click="inviteRegister" slot="bottom">
          <span>邀请家人</span>
        </div>
      </view-box>
      <!--搬离此住址dialog begin-->
