content = [{
    ...
    item_android: [{ name: "关于智慧物管APP", url: "./about/wg/aboutwg.html" },
                  { name: "新功能介绍", url: "./index.html#/aboutdetail/butler?token=" + token + "&companyCode=" + companyCode + "&version=" + version },
                  { name: "软件许可使用协议", url: "./about/agreement/butlerAgree-android.html" },
                  { name: "回来啦社区下载", url: "./about/wg/lcload.html" }],
    item_ios: [{ name: "关于智慧物管APP", url: "./about/wg/aboutwg.html" }, { name: "新功能介绍", url: "./index.html#/aboutdetail/butler?token=" + token + "&companyCode=" + companyCode + "&version=" + version },
...
},
{
    ...
    item: [{ name: "新功能介绍", url: "./index.html#/aboutdetail/merchan?token=" + token + "&companyCode=" + companyCode + "&version=" + version },
          { name: "软件许可使用协议", url: "./about/agreement/MerchantAgree.html" }],
},
{
    category: "greenTown",
    // 去除功能介绍
