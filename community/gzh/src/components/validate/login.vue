<template>
  <div class="login">
    ...
    <div v-transfer-dom>
      ...
      <x-dialog v-model="showSubscribeDialog" :hide-on-blur="false" class="subscribe">
        <div class="subscribe-wrapper">
          <div class="text-wrapper">
            <p class="text" v-text="tips"></p>
          </div>
          <div class="btn">
            <span @click="backToDetail" class="confirm">确定</span>
          </div>
        </div>
      </x-dialog>
    </div>
  ...
  export default {
    ...
    data () {
      return {
        ...
        tips: '请先搜索并关注“' + window.commonConfig.gzhName + '”公众号，即可报名',
        disabled: false,
        text: '获取验证码',
        timer: null,
        count: 0,
    ...
    methods: {
      ...
      isBind () {
        ...
        _this.$JHttp({
          ...
          // 未关注公众号
          if (!subscribe) {
            _this.showSubscribeDialog = true;
            return;
          }
