<template>
  <div class="publishActivity commonHeader">
    <view-box ref="viewBox" body-padding-top="1.253333rem" body-padding-bottom="1.333333rem">
      <x-header
        slot="header"
        :left-options="{backText: '', showBack: !isApp}"
        title="发布活动"
      ...
      <div class="pubBanner">
        ...
        <ul class="choosePoster" v-show="!isApp">
          <li class="poster" v-show="posters">
            ...
            <j-img :osskey="posters" :custom-width="375" :custom-height="214" @click.native.prevent="showMenu"></j-img>
          </li>
        ...
        <div class="choosePosterForApp" v-show="isApp">
          ...
          <form><input type="file" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" multiple id="xFile"
                       class="uploadPoster" @change="choosePoster_app"></form>
        </div>
        <div class="options">
          ...
          <div class="afterFee">
            ...
            <ul class="chooseImg" v-show="!isApp">
              <li v-for="(imgList, index) in imgList">
                ...
                <!--<j-img :osskey="imgList" :custom-width="105" :custom-height="105" @click.native="showDeletePop(index)"></j-img>-->
              </li>
...
//            _this.posters = _this.pos_Images[0]
            _this.upLoadPoster(e.target.result)
          }
        }
      },
      choosePoster_app (e) {
...
//                })
      ...
      upLoadPoster (val) {
        ...
        _this_.uploadBlob([file], 'activity', undefined, undefined, function (resList) {
          _this_.poster = resList[0];
          _this_.posters = resList[0];
        });
      },
      showMenu () {
        if (this.isApp) {
...
//          console.log(this.feeNumber, this.formItem.reFundWay);
        ...
        if (!token) {
          ...
          if (imgLen) {
            ...
            let params = {
              ...
              joinMoney: _this.formItem.needFee ? (_this.formItem.registeryFee || 0) : 0,
      ...
      upLoadPic (data, length, key) {
        ...
        // 合成完最后一个,开始上传
        if (key === length - 1) {
          _this.uploadBlob(_this.imgBlobs, 'activity', undefined, undefined, function (resList) {
            let params = {
              activityName: _this.formItem.theme,
              activityPicture: _this.poster,
              picList: resList,
