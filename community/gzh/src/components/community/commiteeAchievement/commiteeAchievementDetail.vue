<template>
  <div class="commonHeader commiteeAchievementDetail">
      ...
      getBuildDetail (loaded) {
        ...
        that.$JHttp({
          ...
          if (res.status === 100) {
            ...
            that.commonLists.type = 'commiteeAchievement';
...
//            menu3: '举报'
      ...
      likeIt (value) {
        if (!this.token) {
          ...
          //   type = 6
          // } else if (value.type === 'commiteeAchievement') {
          //   type = 18
          // }
          let _this = this;
