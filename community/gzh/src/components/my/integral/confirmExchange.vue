    ...
    <div class="consignee">
      ...
      <div class="shop_details">
        <div class="shop_details_a">
          <div class="details_top">
            ...
            <div class="details_right">
              ...
              <div class="details_num">
                <span class="details_number">{{informationList.requiredScore}}<span style="font-size: 12px; display: inline-block;">积分</span></span>
                <div class="by_num">
          ...
          <div class="details_bottom">{{informationList.tips}}</div>
        </div>
      </div>
