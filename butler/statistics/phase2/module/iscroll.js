define(function (require, exports, module) {
    ...
    // console.log(offset);
    function trigger_myScroll(offset,domId,callback) {
        ...
        myScroll.on('scroll', function () {
            ...
            if ($('#wrapper ul > li').length >= items_per_page) {
                ...
                console.log(this.y);
                pullActionDetect.check(0,callback);
    ...
    exports.onScroll = function (domId, callback) {
        trigger_myScroll(undefined, domId, callback);
    }
});